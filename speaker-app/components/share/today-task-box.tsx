...
const TodayTaskBox = ({ title, count, type }: todayTaskType) => {
  ...
  return (
    <View className="h-[110px] w-[110px] gap-5 bg-primary rounded-[12px] px-3 py-2 relative overflow-hidden">
      <Text
      ...
      <View className="absolute bottom-0 left-3 justify-between flex-row w-full">
        <Text className="text-white text-left text-title-small  font-bold">
          0/{count}
        </Text>
        {boxIcon}
      </View>
