    ...
    >
      <View className="flex-row justify-between">
        <View className="flex-row gap-3 items-center">
          ...
          <View className="">
            <Text
              className={`text-title-medium ${isDarkMode ? "text-bg-light" : "text-bg-dark"}`}
            >
              {userName}
            </Text>
            <Text
        ...
        <Entypo
          ...
          size={24}
          color={isDarkMode ? "#4C4C4C" : "#D7D7D7"}
        />
      </View>
      ...
      <View className="flex-row gap-4">
        <View className="flex-1">
          <Button fullCustomClassName="bg-green justify-center items-center py-2 rounded-[12px]">
            Correct
          </Button>
        </View>
        <View className="flex-1">
          <Button fullCustomClassName="bg-red justify-center items-center py-2 rounded-[12px]">
            Uncorrected
          </Button>
        </View>
      </View>
