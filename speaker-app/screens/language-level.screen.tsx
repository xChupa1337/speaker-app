...
const LanguageLevelScreen = () => {
  ...
  const handlePress = () => {
    if (selectedLanguageLevel) router.push("/auth/select-daily-time");
  };
    ...
    <GestureHandlerRootView className="flex-1">
      ...
      >
        ...
        >
          <View>
            <Text
              className={`${isDarkMode ? "text-body-primary-dark" : "text-body-primary-light"} text-title-large`}
            >
              Choose your level:
            </Text>
            ...
            {dummyLanguagesLevel.map((item) => (
              <LanguageLevelCard
                ...
                full={item.full}
                key={item.short}
                isSelected={selectedLanguageLevel === item.short}
          ...
          <Button
            ...
            fullCustomClassName={
              selectedLanguageLevel
                ...
                : `${isDarkMode ? "bg-body-secondary-dark" : "bg-body-secondary-light"} ${buttonStyle}`
            }
            textClassName={
              selectedLanguageLevel
                ? ""
                : `${isDarkMode ? "text-border-dark" : "text-border-light"}`
            }
          >
            Continue
          </Button>
